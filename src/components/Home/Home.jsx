      ...
      <div className="carousel2_container">
        ...
        <div className="carousel_2">
          ...
          >
            ...
            <Carousel.Item>
              <img className="d-block2 w-100" src={razer} alt="Third slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block2 w-100" src={nvidia} alt="Third slide" />
            </Carousel.Item>
            <Carousel.Item>
              <img className="d-block2 w-100" src={hyper} alt="Third slide" />
            </Carousel.Item>
          </Carousel>
        </div>
      </div>
